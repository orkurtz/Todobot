...
*1 · יצירה ושפה*
פשוט כתוב מה צריך לעשות — בעברית או באנגלית, טקסט או 🎤 הקלטה.
...
*2 · תאריכים*
יחסיים: "מחר ב-15:00" · "בעוד שעתיים" · "ביום ראשון ב-10:00"
מדויקים: "31/10 בשעה 14:30" · "15/11/2025 ב-09:00"

*3 · השלמה*
• "סיימתי משימה 2" (מספר ברשימה)
• "סיימתי להתקשר לאמא" (לפי שם)
• כתוב "פירוט" ואז 👍 על כל הודעת משימה
...
• "כל שבוע פגישה עם המנהל" · "כל יומיים להשקות צמחים" · "כל ה-15 בחודש להעביר שכירות"
ניהול: "משימות חוזרות" · "עצור סדרה [מספר]" · "השלם סדרה [מספר]"

*7 · יומן Google*
• "חבר יומן" · "נתק יומן" · "סטטוס יומן"
• "הצג יומן" · "הגדרות יומן"
• "קבע צבע [1-11]" · "הפעל #" / "כבה #"

*8 · רשימות וחיפוש*
• "משימות" או "?" — רשימה
• "פירוט" · "הושלמו" · "סטטיסטיקה" · "סיכום יומי"
• "מתי הפגישה עם יוחנן?" · "כמה משימות יש לי?"
